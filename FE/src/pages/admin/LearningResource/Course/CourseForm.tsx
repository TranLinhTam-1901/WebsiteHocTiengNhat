...
import { CourseDTO, CreateUpdateCourseDTO } from '../../../../interfaces/Admin/Course';
...
const CourseForm: React.FC = () => {
  ...
  useEffect(() => {
    const loadInitialData = async () => {
      try {
        ...
        if (id) {
          const course: CourseDTO = await courseService.getById(id);
  ...
  const handleSave = async () => {
    if (!formData.courseName.trim() || !formData.levelID) {
      alert('Vui lòng điền các trường bắt buộc.');
      return;
    }

    const payload: CreateUpdateCourseDTO = {
    ...
    try {
      ...
      navigate('/admin/resource/course');
    } catch (error: any) {
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="flex flex-col text-left">
              <h2 className="text-xl font-bold text-[#181114] uppercase">
                {id ? 'Chỉnh sửa khóa học' : 'Thêm khóa học'}
              </h2>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
              <div className="space-y-2">
                ...
                <p className="text-[12px] text-[#b399a4] italic">
                  Tên khóa học nên thể hiện rõ cấp độ hoặc mục tiêu học tập.
                </p>
              </div>
              ...
              <div className="space-y-2">
                ...
                <p className="text-[12px] text-[#b399a4] italic">
                  Cấp độ giúp phân loại khóa học theo lộ trình JLPT.
                </p>
              </div>
              ...
              <div className="space-y-2 lg:col-span-2">
                ...
                <p className="text-[12px] text-[#b399a4] italic">
                  Mô tả ngắn giúp admin và học viên hiểu nội dung chính của khóa học.
                </p>
              </div>
            </div>
          </section>
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                <h4 className="font-bold text-[#181114]">
                  Khóa học là nhóm bài học theo cấp độ
                </h4>
                <p className="text-sm text-[#886373] mt-1 leading-relaxed">
                  Sau khi tạo khóa học, bạn có thể thêm các bài học con bên trong.
                  Thứ tự bài học sẽ được xử lý tại phần quản lý bài học.
                </p>
              </div>
            </div>
          </section>
