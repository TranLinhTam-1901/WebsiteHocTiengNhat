                  ...
                  <div className="space-y-2">
                    {q.answers.map((opt, optIdx) => {
                      ...
                      return (
                        <div
                          key={opt.answerID}
                          className={`flex items-center gap-4 rounded-xl border-2 px-5 py-3 ${
                            isCorrect
                              ...
                              <div
                                ...
                                className={`flex items-center gap-3 rounded-xl border-2 px-4 py-2.5 ${
                                  isCorrect
                                    ...
                                    : isWrongSelected
                                      ? 'border-rose-400 bg-rose-50'
                                      : 'border-[#e8e2e6] bg-white'
                                }`}
                              >
                                <span
                                  className={`flex size-7 shrink-0 items-center justify-center rounded-full border-2 text-xs font-black ${
                                    isCorrect
                                      ? 'border-emerald-500 bg-emerald-500 text-white'
                                      : isWrongSelected
                                        ? 'border-rose-500 bg-rose-500 text-white'
