...
public interface IOllamaTutorService
{
    ...
    Task<TutorCharacterReplyDto> CharacterChatAsync(IReadOnlyList<TutorChatMessageDto> clientMessages, string? learnerJlptLevel, TutorKnowledgeContext? knowledge, CancellationToken cancellationToken = default);
}
